...
public class Level5 extends EnigmeArea {
	...
	protected void initActors() {
		...
		Torch torchA = new Torch (this, Orientation.DOWN, new DiscreteCoordinates(18,27), false);
		torchA.enterArea(this, new DiscreteCoordinates(18,27));
		SignalRock rock2 = new SignalRock(this,Orientation.DOWN,new DiscreteCoordinates(17,26), ((Logic)torchA));
